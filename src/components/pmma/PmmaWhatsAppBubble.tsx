...
export function PmmaWhatsAppBubble() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Falar com a Edital360 no WhatsApp"
      className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-4 z-50 flex h-13 w-13 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_40px_-14px_rgba(37,211,102,0.8)] ring-1 ring-white/20 transition hover:brightness-110 active:scale-95 sm:h-14 sm:w-14"
    >
